function StartPOI = Nidulans_abaA_Search()
%% Info about this File:
% Written by: Joe Zavorskas
% Start: 9/9/2021 (Birthday Coding!)
% Last Edit: 9/29/2022

% This file will contain a workflow to search for clumps of abaA's
% experimentally proven binding motif (Chang; Timberlake, 1992) in 
% the nidulans genome. This algorithm is an easy version of the motif
...
%%% well.
temp = regexp(fileread("Nidulans Chromo8.txt"), '\r?\n', 'split');
